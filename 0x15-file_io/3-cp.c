 ...
 * @file: Name of the txt file the buffer will store chars into.
 *
...
/**
 * main - Copying the contents of a file to another txt file.
 ...
 * If file_to or file_from is not able to closed - exit code 100.
 */
